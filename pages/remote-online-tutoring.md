...
> 🏷️ **Category:** Low-Barrier Entry Points

---

## 🌟 Strategic Overview & Opportunity

Deliver 1-on-1 tutoring in STEM, languages, and coding to global students. In 2026, leveraging generative AI workflows, hyper-targeted distribution, and automated tooling allows individual operators and boutique agencies to generate substantial cash flow with minimal upfront overhead.
...
| :--- | :--- | :--- | :--- |
| **Preply** | Tutoring Network | 18%-33% commission | Free tutor sign-up |
| **Wyzant** | Tutoring Hub | 25% fee on earnings | Free tutor sign-up |
| **Miro** | Digital Whiteboard | Starter: $8/member/mo | Free tier with 3 editable boards |
| **Calendly** | Scheduling Automation | Standard: $10/seat/mo | 1 calendar connection & 1 event type free |
...
- **Total Industry Market Size (2026):** `~$46 Billion in global 1-on-1 online tutoring and specialized education`
- **Estimated Individual Earning Potential:** `$25 - $120/hour ($2,000 - $6,000/mo)`
