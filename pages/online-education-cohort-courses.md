# 🚀 Online Education & Cohort Courses
...
Package domain expertise into interactive live cohort bootcamps. In 2026, leveraging generative AI workflows, hyper-targeted distribution, and automated tooling allows individual operators and boutique agencies to generate substantial cash flow with minimal upfront overhead.
...
| :--- | :--- | :--- | :--- |
| **Maven** | Cohort Courses | 10% platform fee on sales | Free to apply and build course |
| **Teachable** | Course Platform | Basic: $39/mo, Pro: $119/mo | Free tier ($1 + 10% fee, 1 course) |
| **Loom** | Video Messages | Business: $12.50/creator/mo | 25 videos free (up to 5 mins each) |
| **Zoom** | Video Meetings | Pro: $13.33/mo | 40-minute limit for up to 100 participants free |
